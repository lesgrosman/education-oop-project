...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus', '.msg').render();
});
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides[0].classList.add(this.activeClass); // activeCalss for slide with index = 0 
    ...
    value: function bindTriggers() {
      ...
      this.next.addEventListener('click', function () {
        _this3.container.appendChild(_this3.slides[0]); // When click 'next' move first slide in the end of container


        _this3.decorizeSlides();

        _this3.moveBtnsToEnd();
      });
      this.prev.addEventListener('click', function () {
        var active = _this3.slides[0]; // last slide

        _this3.container.insertBefore(active, _this3.slides[_this3.slides.length - 1]); // // When click 'prev' move last slide in the beginning of container
      ...
      try {
        ...
        if (this.autoplay) {
          setInterval(function () {
            _this4.container.appendChild(_this4.slides[0]); // When click 'next' move first slide in the end of container
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTrigers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blockedElem = btn.closest('.module__video-item').nextElementSibling; // 1st: getting module depends to activeBtn. 2st: getting next module
        ...
        btn.addEventListener('click', function () {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            // We can click the button if module IS NOT disable
            _this.activeBtn = btn;
    ...
    value: function onPlayerStateChange(state) {
      try {
        var blockedElem = this.activeBtn.closest('.module__video-item').nextElementSibling; // 1st: getting module depends to activeBtn. 2st: getting next module

        var playBtn = this.activeBtn.querySelector('svg').cloneNode(true); // copy active button to paste it into blocked module

        if (state.data === 0) {
          // Check if video was watched to the end
